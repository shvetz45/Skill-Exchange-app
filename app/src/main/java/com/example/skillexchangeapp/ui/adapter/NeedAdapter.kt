...
class NeedAdapter(private val onItemClick: (NeedPost) -> Unit) :
    ...
    inner class NeedViewHolder(private val binding: ItemNeedBinding) :
        ...
        fun bind(item: NeedPost) {
            ...
            binding.tvSkill.text = context.getString(R.string.skill_format, item.skillRequired)
            binding.tvHours.text = context.getString(R.string.estimated_hours_format, item.estimatedHours)
